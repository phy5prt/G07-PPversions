...
//		Debug.Log(" orvolt100perc after received settings is " + ourVolt100PercMax);
	...
	//	}else {MovePower = 0;}
		...
		forwardSpeed = (ourShipsPlayerPairSettings.GetmyLeftVolt() + ourShipsPlayerPairSettings.GetmyRightVolt() )*forwardMultiplier/ourVolt100PercMax; //soemtime get not set to instance of object wonder if to do with death it isnt
